...
<section class="jumbotron text-center">
    <div class="container">
        <h1 class="jumbotron-heading">SẢN PHẨM CỦA TRANG</h1>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h4 class="card-title"><a
                                            href="index.php?page=product-detail&id-product=<?php echo $product['id']; ?>"
                                            title="View Product"><?php echo $product['name'] ?></a></h4>
