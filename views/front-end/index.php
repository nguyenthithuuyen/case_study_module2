...
<section class="jumbotron text-center">
    <div class="container" style="background-image: url("2.gif") ">
...
<!--                            <div class="card-body">-->
<!--                                <h4 class="card-title"><a href="index.php?page=product-detail&id-product=--><?php //echo $category['id']; ?><!--" title="View Product">--><?php //echo $category['name'] ?><!--</a></h4>-->
<!--                                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>-->
<!--                                <div class="row">-->
<!--                                   <div class="col">-->
<!--                                        <p class="btn btn-danger btn-block">-->--><?php ////echo $category['price'] ?>
<!--                                    </div>-->-->
<!--                                    <div class="col">-->
<!--                                        <a href="#" class="btn btn-success btn-block">Add to cart</a>-->
<!--                                    </div>-->
